...
![sql](http://reverse-tcp.xyz/static/img/_posts/Joomla/com_fields_sql.png)

这里附一张该漏洞的审计思路图，看起来比较复杂，但是表哥们配合本文调试一遍应该就都可以理解该漏洞了。

![mind](http://reverse-tcp.xyz/static/img/_posts/Joomla/com_fields_mind.png)
...
![solution](http://reverse-tcp.xyz/static/img/_posts/Joomla/com_fields_solution.png)
